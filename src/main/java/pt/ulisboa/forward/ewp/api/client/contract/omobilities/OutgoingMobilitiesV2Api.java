...
/**
 * Contract interface for the Outgoing Mobilities V2 Forward EWP API.
 *
 * @see <a href="https://github.com/erasmus-without-paper/ewp-specs-api-omobilities/tree/stable-v2">Specification</a>
 */
public interface OutgoingMobilitiesV2Api extends BaseApi {
   ...
   */
  @RequestLine("GET /api/forward/ewp/omobilities/v2/specification?hei_id={hei_id}")
   ...
   *                                given point in time.
   * @return See <a href="https://github.com/erasmus-without-paper/ewp-specs-api-omobilities/blob/stable-v2/endpoints/index-response.xsd">Response
   * specification</a>
   */
  @RequestLine("POST /api/forward/ewp/omobilities/v2/index")
  @Headers("Content-Type: application/x-www-form-urlencoded")
  ResponseWithDataDto<OmobilitiesIndexResponseV2> findAllByHeiId(
