 ...
 *
 * @see <a
 * href="https://github.com/erasmus-without-paper/ewp-specs-api-iias/tree/stable-v6">Specification</a>
 */
public interface InterInstitutionalAgreementsV6Api extends BaseApi {
     ...
     * @return See <a
     * href="https://github.com/erasmus-without-paper/ewp-specs-api-iias/blob/stable-v6/endpoints/index-response.xsd">Response
     * specification</a>
     */
     ...
     * @param sendPdf Boolean, default false. Value false means, that the client is not interested
     *                in receiving PDF version of the agreement and the PDF SHOULD be skipped in the
     *                response.
     * @return See <a
     * href="https://github.com/erasmus-without-paper/ewp-specs-api-iias/blob/stable-v6/endpoints/get-response.xsd">Response
     * specification</a>
     ...
     *                 referenced IIAs (otherwise, IIA won't be found).
     * @param sendPdf  Boolean, default false. Value false means, that the client is not interested
     *                 in receiving PDF version of the agreement and the PDF SHOULD be skipped in
     *                 the response.
     * @return See <a
     * href="https://github.com/erasmus-without-paper/ewp-specs-api-iias/blob/stable-v6/endpoints/get-response.xsd">Response
     * specification</a>
